...
{ step: 'play_card',             iid, equip_to? }  
{ step: 'play_legend_solo',      iid }
{ step: 'play_legend',           iid }
{ step: 'activate_anytime_spend', iid, ability_idx }
{ step: 'declare_attack', attacker_iid, target: { kind: 'gigs' } }
...
{ step: 'play_card_interrupt_cast', iid }
